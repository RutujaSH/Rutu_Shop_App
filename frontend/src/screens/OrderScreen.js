                ...
                <ListItem>
                  <ListItemText
                    ...
                    secondary={
                      <span>
                        <p>
                          Rs. <strong>Items price:</strong> {Number(order.itemsPrice).toFixed(2)}
                        </p>
                        <p>
                          Rs. <strong>Shipping costs:</strong> {order.shippingPrice}
                        </p>
                        <p>
                          Rs. <strong>Tax costs:</strong> {order.taxPrice}
                        </p>
                        <p>
                          Rs. <strong>Total price:</strong> {order.totalPrice}
                        </p>
                      </span>
                    }
                    classes={{ primary: classes.primaryListItemText }}
